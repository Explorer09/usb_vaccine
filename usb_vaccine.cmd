...
IF NOT "X!opt_mkdir!"=="XSKIP" (
    ...
    ECHO again, we will create a hidden directory with the same name. Users won't see
    ECHO the directory, but it can interfere with the malware. Unless the malware has
    ECHO the ability to delete it, the drive won't be infected by AutoRun any more.
